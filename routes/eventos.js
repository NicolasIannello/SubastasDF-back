...
router.post('/crearEvento', [
    ...
    check('hora_inicio','el campo es obligatorio').not().isEmpty(),
    check('hora_cierre','el campo es obligatorio').not().isEmpty(),
    check('segundos_cierre','el campo es obligatorio').not().isEmpty(),
    ...
    check('mostrar_precio','el campo es obligatorio').not().isEmpty(),
    check('mostrar_ganadores','el campo es obligatorio').not().isEmpty(),
    check('mostrar_ofertas','el campo es obligatorio').not().isEmpty(),
