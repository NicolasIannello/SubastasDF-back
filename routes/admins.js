...
const { login, renewToken, getUsers, deleteUser, actualizarUser, crearAdmin, buscarDato, excelUsuarios, getAdmins, comunicar, reComunicado, setStatus, getRegistroTC } = require('../controllers/admin');
